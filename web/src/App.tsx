    ...
    <div className='max-w-[1344px] mx-auto my-20 flex flex-col items-center'>
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white rounded-lg w-[480px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-black/25'>
